...
class _BranchListScreenState extends State<BranchListScreen> {
    ...
    return Consumer<BranchProvider>(builder: (context, branchProvider, _) {
      return CustomPopScopeWidget(
        ...
        child: Scaffold(
          ...
          splashProvider.getActiveBranch() == 0 ? const BranchCloseWidget() : Column(children: [
  ...
  Future<void> _onInit() async {
    ...
    List<BranchValue>? branchValues = await branchProvider.branchValueList;
