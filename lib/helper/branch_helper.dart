...
class BranchHelper{
  ...
  static void setBranch(BuildContext context, {bool frmDashboard = false}) {

    final branchProvider = Provider.of<BranchProvider>(context, listen: false);
    final splashProvider = Provider.of<SplashProvider>(context, listen: false);
    debugPrint("inside branch helper 1");
    ...
    if(branchProvider.getBranchId() != branchProvider.selectedBranchId) {
      ...
      if(!frmDashboard) {
        ...
        debugPrint("Selected branch 1");
        if (RouterHelper.dashboard == GoRouter
            .of(Get.context!)
      ...
      debugPrint("Selected branch else part");
